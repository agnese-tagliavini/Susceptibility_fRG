...
template< size_t ndims > void read( boost::multi_array<std::complex<double>, ndims>& my_arr, H5::Group& group);  ///< Reads complex<double> valued boost multi_array from given group of hdf5 file
