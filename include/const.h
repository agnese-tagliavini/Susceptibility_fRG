...
#else
#ifdef UNIFORM_GRID
const int MAX_KPOS = 1;						///< Points on positive kx,ky,kz directions 
const int PATCH_COUNT = 8*MAX_KPOS*MAX_KPOS*MAX_KPOS;		///< Amount of k-patches
...
const int FFACTOR_COUNT = 7;				        ///< Amount of form factors->changed accordingly with NN_COUNT in grid.h 					
