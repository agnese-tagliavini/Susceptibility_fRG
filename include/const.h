...
const int POS_BFREQ_COUNT_ATRI =  POS_BFREQ_COUNT_TRI;		///< Amount of positive bosonic frequencies in P grid 
const int BFREQ_COUNT_ATRI = 2 * POS_BFREQ_COUNT_ATRI + 1;	///< Amount of bosonic frequencies in P grid

const int POS_BFREQ_COUNT_SUSC = 6 * COUNT; 
const int BFREQ_COUNT_SUSC = 2 * POS_BFREQ_COUNT_SUSC + 1; 
...
const int FFACTOR_COUNT = 3; ///< Amount of form factors->changed accordingly with NN_COUNT in grid.h 					
...
const int FFT_DIM = 32; 	///< Dimension of the FFT grid in every directions
