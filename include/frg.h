...
MatQN G0inv( double w, double kx, double ky, double kz);					///< Inverse non-interacting Greens function ( scale-independent! )

MatQN G( double w, double kx, double ky, double kz, const MatQN& selfEn );	///< Scale-dependent Greens function, introduce regulator here!
