...
//---- ALL SYMM 
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_ph_to_pp(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_2pi3_111_projmat, rot_2pi3_1m11_projmat, rot_2pi3_m111_projmat, rot_2pi3_m1m11_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_pp_to_ph(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_2pi3_111_projmat, rot_2pi3_1m11_projmat, rot_2pi3_m111_projmat, rot_2pi3_m1m11_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_ph_to_xph(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_2pi3_111_projmat, rot_2pi3_1m11_projmat, rot_2pi3_m111_projmat, rot_2pi3_m1m11_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });

//---- ALL SYMM - NO 2PI3 SYMM
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_ph_to_pp(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_pp_to_ph(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });
//symmetry_grp_t<dcomplex,6> state_t::symmetry_grp_proj_matrix_ph_to_xph(gf_proj_matrix_t(),{ rot_pi2_x_projmat, rot_pi2_y_projmat, rot_pi2_z_projmat, rot_pi_110_projmat, rot_pi_1m10_projmat, rot_pi_011_projmat, rot_pi_01m1_projmat, rot_pi_101_projmat, rot_pi_10m1_projmat });
...
dcomplex state_t::phi_ph_outside( int W, int w_in, int w_out, int K, int n_in, int n_out, int s1_in, int s2_in, int s1_out, int s2_out ) const
{
   ...
   int bf_sign_z = (1-(1-translate_2pi_z(n_in)*translate_2pi_z(n_out))*bf[2]);
   return chi_ph( W, K, s1_in, s2_in, s1_out, s2_out ) * double((n_in==0) * (n_out==0)) +
      ...
      P_ph( -W, w_out, minusK, n_out, s2_in, s1_in, s2_out, s1_out ) * double(bf_sign_x * bf_sign_y * bf_sign_z * (n_in==0));  // flip diagram horizontally
}
...
dcomplex state_t::phi_xph_outside( int W, int w_in, int w_out, int K, int n_in, int n_out, int s1_in, int s2_in, int s1_out, int s2_out ) const
{
   ...
   return chi_xph( W, K, s1_in, s2_in, s1_out, s2_out ) * double((n_in==0) * (n_out==0)) + 
      ...
      P_xph( -W, w_out, minusK, n_out, s2_in, s1_in, s2_out, s1_out ) * double(bf_sign_x * bf_sign_y * bf_sign_z * (n_in==0));  // flip diagram horizontally
}
...
{
   return G( w_val( idx(0) ), get_kx(idx(1)), get_ky(idx(1)), get_kz(idx(1)), SigMat( idx(0), idx(1) ) )( idx(2), idx(3) ); 
}
...
MatQN state_t::GMat( const idx_1p_mat_t& idx) const
{
   ...
   return G( w_val( idx(0) ), get_px(idx(1)), get_py(idx(1)), get_pz(idx(1)), SigMat( idx(0), idx_k ) ); 
}
